...
// SEO Meta
useHead({
  title: "Privacy Policy - Vipin Kumar Madhaan",
  meta: [
    {
      name: "description",
      content:
        "Privacy policy for devpy.de - Learn how I collect, use, and protect your personal information on my website.",
    },
    {
      property: "og:title",
      content: "Privacy Policy - Vipin Kumar Madhaan",
    },
    {
      ...
      <div class="space-y-8">
        ...
        <UCard class="">
          <div class="space-y-4">
            ...
            <p>
              Welcome to devpy.de ("I," "my," or "me"). This privacy policy
              explains how Vipin Kumar Madhaan collects, uses, and protects your
              personal information when you visit my website or use my services.
              I are committed to protecting your privacy and ensuring
              transparency about my data practices.
            </p>
            <p>
        ...
        <UCard class="">
          <div class="space-y-4">
            ...
            <UAlert
              ...
              description="To exercise any of these rights, please contact me at mail@devpy.de. I will respond within 30 days."
            />
          </div>
        </UCard>
