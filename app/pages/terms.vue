...
// SEO Meta
useHead({
  title: "Terms of Service - Vipin Kumar Madhaan",
  meta: [
    {
      name: "description",
      content:
        "Terms of service for devpy.de - Learn about my service terms, client agreements, and professional guidelines for working together.",
    },
    {
      property: "og:title",
      content: "Terms of Service - Vipin Kumar Madhaan",
    },
    {
...
<template>
  <div>
    <!-- Header -->
    <div class="text-center space-y-8 pt-12 pb-8">
    ...
    <div class="space-y-8">
      ...
      <UCard class="">
        <div class="space-y-4">
          ...
          <p>
            Welcome to devpy.de ("I," "my," or "me"). These Terms of Service
            ("Terms") govern your use of my website and any professional
            services provided by Vipin Kumar Madhaan ("I," "my," or "me"). By
